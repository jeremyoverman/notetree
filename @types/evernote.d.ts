...
declare module 'evernote' {
    ...
    class NoteStoreClient {
         ...
         * </ul>
         */
        updateNotebook(notebook: Notebook): Promise<number>;
         ...
         * </ul>
         */
        findNotesMetadata(filter: NoteFilter, offset: number, maxNotes: number, resultSpec: NotesMetadataResultSpec): Promise<NotesMetadataList>;
